...
ha = current.day
today = date.today()
hamii2 = f"\033[1;33m➤{GREEN}➤\x1b[0m"
import random
cokbrut=[]
...
for xd in range(10000):
    a='Jibon/5.0 (Symbian/3; Series60/'
...
for xd in range(3000):
    ...
    ugent1 = f"Jibon/5.0 (Linux; Android {str(rr(4,12))}; {str(rc(gt))}) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/{str(rr(100,104))}.0.{str(rr(3900,4900))}.{str(rr(40,150))} Mobile Safari/537.36 {str(rc(aZ))}{str(rr(1,1000))}"
    ugent2 = f"Jibon/5.0 (Linux; Android 4.1.2; Nokia_X Build/{str(rc(build_nokiax))}) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/{str(rr(100,104))}.0.{str(rr(3900,4900))}.{str(rr(40,150))} Mobile Safari/537.36 NokiaBrowser/7.{str(rr(1,5))}.1.{str(rr(16,37))} {str(rc(aZ))}{str(rr(1,1000))}"
    ugent3 = f"Jibon/5.0 (Linux; U; Android {str(rr(4,12))}; {str(rc(basa))}; Redmi 5 Plus Build/N2G47H) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/{str(rr(40,104))}.0.{str(rr(3900,4900))}.{str(rr(40,150))} Mobile Safari/537.36 XiaoMi/MiuiBrowser/{str(rr(1,99))}.{str(rc(miui_v1))}.{str(rc(miui_v2))}{str(rc(miui_v3))} {str(rc(aZ))}{str(rr(1,1000))}"
    memekk = random.choice([ugent1, ugent2, ugent3])
    ugen.append(memekk)
    
for t in range(10000):
    aa='Jibon/5.0 (Linux; Android 7.0; '
    ...
    ugen.append(uaku)
for x in range(10):
    a='Jibon/5.0 (SAMSUNG; SAMSUNG-GT-S'
...
logo ="""     \033[1;37m____ \033[1;32m             ______     _______   \033[1;37m____   
    ...
    \033[1;37m| |\033[1;32m    jibon hacker \033[1;37m        | |  
...
\033[1;31m│\033[1;37m☞  \033[1;32mAUTHER     \033[1;31m➟   \033[1;32mMD JIBON ISLAM           \033[1;31m│
\033[1;31m│\033[1;37m☞  \033[1;32mFACEBOOK   \033[1;31m➟   \033[1;32mJ  I  B  O  N          \033[1;31m│
\033[1;31m│\033[1;37m☞  \033[1;32mGITHUB    \033[1;31m ➟  \033[1;32m J65653                \033[1;31m │
\033[1;31m│\033[1;37m☞  \033[1;32mYOUTUBE   \033[1;31m ➟   \033[1;32mno                  \033[1;31m   │
\033[1;31m│\033[1;37m☞  \033[1;32mVERSION   \033[1;31m ➟   \033[1;32m1.3                          \033[1;31m   │
\033[1;31m│\033[1;37m☞  \033[1;32mGROUP\033[1;31m : \033[1;32mtermux command sell\033[1;37m {\033[1;36mHBF\033[1;37m} \033[1;31m│
\033[1;37m╚\033[1;36mⒽⒷⒻ\033[1;37m══════\033[41m\033[1;37m[ 𓆩J  I  B  O  N𓆪 𓆩𝐁𝐑𝐔𝐓𝐄𓆪  𓆩𝐅𝐎𝐑𝐂𝐄𓆪 ]\x1b[0m══════\033[1;36mⒽⒷⒻ\033[1;37m╝
...
def XYZ():
    ...
    if hamii in ["1","01"]:
        ...
        os.system("xdg-open https://m.me/H4M11.YOUR.DAD")
        XYZ()
    elif hamii in ["3","03"]:
        os.system("xdg-open https://wa.me/01865544636")
        XYZ()
    elif hamii in ["0","00"]:
       exit()
    else:
...
def Ulti():
    ...
    with ThreadPool(max_workers=30) as manshera:    
        clear()
        tl = str(len(user))
        print(f" {WHITE}TOTAL IDZ             : {BLUE}["+tl+"] ~> Ulti ")
        print(f" {WHITE}USER NAME             : {BLUE}"+NameX)
        print(f" {WHITE}NUMBER YOU PUT        : {YELLOW}"+code)
